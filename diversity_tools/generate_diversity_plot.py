...
from src.matrix_writers import write_file_from_matrix, write_csv_from_matrix
...
def main():
    ...
    out_plot_fpath = out_fdir / "Diversity_DataFrame.svg"
    convert_diversity_matrix_to_graph(Diversity_df, out_plot_fpath)

    out_fpath = out_fdir / "Diversity_DataFrame.csv"
